...
7. SQL Query performance evaluation?  --> indxing
   A. SELECT owner, table_name   FROM dba_tables;
   select INDEX_NAME, TABLE_OWNER, TABLE_NAME, UNIQUENESS from USER_INDEXES;
   select INDEX_NAME, TABLE_OWNER, TABLE_NAME, UNIQUENESS from ALL_INDEXES
8. Left outer join?
9. Spring boot profiles?
10. Deployments related?
11. Stack program?
12. polymorphism   - run time and compile code
13. how to swap values without using third variable in java?
    ...
    a = a ^ b; // a now holds the original value of b
    ```
14. react js component types and code?
15. Design patterns & strategy design pattern, code?
16. SOLID Principles
